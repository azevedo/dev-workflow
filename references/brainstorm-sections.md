...
The existing inline markdown templates in `skills/ba-brainstorm/SKILL.md` remain the canonical
...
this contract and the corresponding inline template in `skills/ba-brainstorm/SKILL.md` must be
